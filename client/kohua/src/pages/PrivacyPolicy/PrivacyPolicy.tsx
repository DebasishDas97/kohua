    ...
    <div className="my-24 md:mx-[100px] mx-0 md:p-8 px-3">
      ...
      <div>
        <p className="md:text-2xl text-xl mb-7">
          Welcome to Kohua! This Privacy Policy outlines how Kohua collects,
          uses, maintains, and discloses information collected from users (each,
          a "User") of the kohua.in website.
        </p>
        ...
        <p className="md:text-xl text-lg mt-3 mb-5">
          We may collect personal identification information from Users when
          they visit our site, register on the site, place an order, subscribe
          to the newsletter, respond to a survey, fill out a form, or engage in
          other activities on our site.
        </p>
        ...
        <p className="md:text-xl text-lg mt-3 mb-5">
          Kohua may collect and use Users' personal information for the
          following purposes:
        </p>
        ...
        <p className="md:text-xl text-lg mt-3 mb-5">
          Kohua has the discretion to update this Privacy Policy at any time.
        ...
        <p className="md:text-xl text-lg mt-3 mb-5">
          By using Kohua, you signify your acceptance of this policy. If you do
