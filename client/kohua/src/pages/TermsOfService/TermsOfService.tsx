export default function TermsOfService() {
  return (
    <div className="my-24 md:mx-[100px] mx-0 p-8">
    <h1 className="text-5xl font-bold text-center mb-8">Terms of Service</h1>

    <div>
      <p className="md:text-2xl text-xl mb-7">
        Welcome to Kohu! These terms of service ("Terms") outline the rules and regulations for the
        use of Kohu's Website, located at kohua.in.
      </p>

      <h2 className="md:text-2xl text-xl">1. Acceptance of Terms</h2>
      <p className="md:text-xl text-lg mt-3 mb-5">
        By accessing this website, we assume you accept these Terms. Do not continue to use Kohu if
        you do not agree to all the Terms stated on this page.
      </p>

      <h2 className="md:text-2xl text-xl">2. License to Use the Website</h2>
      <p className="md:text-xl text-lg mt-3 mb-5">
        Unless otherwise stated, Kohu and/or its licensors own the intellectual property rights for
        all material on Kohu. You may view and/or print pages from kohua.in for your own personal
        use, subject to restrictions set in these Terms.
      </p>

      <h2 className="md:text-2xl text-xl">3. User Account</h2>
      <p className="md:text-xl text-lg mt-3 mb-5">
        If you create an account on Kohu, you are responsible for maintaining the confidentiality of
      ...
      <p className="md:text-xl text-lg mt-3 mb-5">
        Kohu reserves the right to remove any content at any time without notice.
      </p>
      ...
      <p className="md:text-xl text-lg mt-3 mb-5">
        By using Kohu, you agree to abide by these Terms. If you do not agree to these Terms, please
        refrain from using our website.
      </p>

      <p className="md:text-xl text-lg mt-3 mb-5">Last updated: [Date]</p>
    </div>
  </div>
  )
}