...
export default function ErrorPage() {
  return (
    <div className="md:mx-[100px] margin-96 mx-0">
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 md:space-x-8 space-x-0 2xl:space-x-0">
        ...
        <div className="w-auto mx-0 md:w-1/2 flex lg:items-end justify-center p-4">
          <svg
